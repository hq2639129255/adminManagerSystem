...
public class UserinfoDaoImple extends BaseDao<Userinfo> implements UserinfoDao{
    ...
    @Override
    public List<Userinfo> findUserinfoByParameter(Connection con, String userName, int aid, String vname) throws SQLException, NoSuchFieldException, InstantiationException, IllegalAccessException {
